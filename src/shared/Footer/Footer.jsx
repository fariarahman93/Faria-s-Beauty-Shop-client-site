...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-red-400 text-base-content">
        <nav>
        ...
        <nav>
          <header className="footer-title font-semibold">Company</header> 
        ...
        <nav>
          <header className="footer-title font-semibold">Social</header> 
